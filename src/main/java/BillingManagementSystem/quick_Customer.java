 ...
 * @author Akilan P
 */
public class quick_Customer extends javax.swing.JFrame {

    /**
     * Creates new form quick_Customer
     */
    public quick_Customer() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Quick Customer");
        ...
        jLabel2.setText("CSID :-");

        jLabel3.setText("Name :");

        jLabel4.setText("Contact :");

        jLabel5.setText("Rewards :");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String rewards=jTextField4.getText();
        String csmail="1111";
        String add1="1111";
        String add2="1111";
        String add3="1111";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Statement stmt=con.createStatement();
            stmt.executeUpdate("UPDATE customer SET csname='"+csname+"',csno='"+csno+"',rewards='"+rewards+"' WHERE csid='"+csid+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(quick_Customer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
