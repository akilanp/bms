...
public class Admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("DATABASE INJECTOR"));
        ...
        jLabel1.setText("* Please be Carefull commands directly affect Database...");

        jLabel3.setText("* This won't provide Resultsets.");

        jLabel4.setText("* You can run CRUD Operations, Truncate delete or modify anything in the database");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String Execute=jTextField1.getText();
        try {
            int a=JOptionPane.showConfirmDialog(null,"Do you really want to Execute this following command :  "+Execute+"","Select",JOptionPane.YES_NO_OPTION);
        if (a==0) {
            //setVisible(false);
            ...
            JOptionPane.showMessageDialog(this,"Command Successfully updated...");
        }
